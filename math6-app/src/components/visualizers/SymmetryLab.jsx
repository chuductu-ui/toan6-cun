...
export default function SymmetryLab() {
  ...
  const shapes = {
    triangle: {
      ...
      svg: (
        <svg width="150" height="150" viewBox="0 0 100 100" className="geom-svg" data-testid="svg-triangle">
    ...
    square: {
      ...
      svg: (
        <svg width="150" height="150" viewBox="0 0 100 100" className="geom-svg" data-testid="svg-square">
    ...
    rectangle: {
      ...
      svg: (
        <svg width="150" height="150" viewBox="0 0 100 100" className="geom-svg" data-testid="svg-rectangle">
  ...
  return (
    <div className="symmetry-visualizer" data-testid="symmetry-visualizer">
      ...
      <div className="viz-controls flex">
        ...
        <button className="btn-axis" onClick={() => setShowAxis(!showAxis)} data-testid="btn-axis">
